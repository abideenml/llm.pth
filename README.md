...
mHC is residual connections on steroids but within a defined manifold for training 
stability. -> improves performances & scalability of models

2026-01-11
----------
deepseekv3.2 dsa added to architectures. dsa filters kv based on relevance to 
query before attention-> sparse attention O(Tk)<O(T^2) -> handles long context better
