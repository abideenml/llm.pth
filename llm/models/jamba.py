...
class JambaLMConfig:
    ...
    mamba_config = MambaConfig(d_model, n_layers, dt_rank, d_state,
                                        expand_factor, d_conv, dt_min, dt_max,
                                        dt_init, dt_scale, rms_norm_eps,
                                        bias, conv_bias, inner_layernorms,
                                        pscan, use_cuda)
...
if __name__ == "__main__":
    device = "mps"
    model = Jamba(JambaLMConfig).to(device)
